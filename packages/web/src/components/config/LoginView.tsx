    ...
    return (
        <div className="max-w-xl mx-auto py-8">
            <div className="config-card flex flex-col items-center text-center">
                ...
                <button
                    onClick={onLogin}
                    className="mt-8 flex w-full items-center justify-center gap-3 rounded-full bg-white hover:bg-white/90 px-8 py-3.5 text-sm font-semibold text-black transition-opacity shadow-lg cursor-pointer"
                >
